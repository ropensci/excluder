...
#'
exclude_progress <- function(x, id_col = "ResponseId", silent = FALSE, ...) {
  ...
  if (silent == FALSE) {
    message(n_exclusions, " out of ", nrow(x), " rows with incomplete progress were excluded, leaving ", n_remaining, " rows.")
  }
